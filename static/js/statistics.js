...
function processSeen(seen) {
    ...
    for (var i = 0; i < seen.pokemon.length; i++) {
        ...
        var pokemon_icon = generateImages ? `<img height='30' class='pokemon_icon' src='${get_pokemon_raw_icon_url(pokemonItem)}'>` : `<i class="pokemon-sprite n${pokemonItem.pokemon_id}"</i>`
        $('#stats_table > tbody')
